...
Assuming flow occurs in the fractures only, the flow equations of the fracture element is written for each phase in multi-phase flow as shown followed by the transfer function of each phase:
